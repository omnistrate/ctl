...
const (
	createExample = `# Delete an instance deployment
...
func init() {
	createCmd.Flags().StringP("output", "o", "text", "Output format (text|json)")
	createCmd.Flags().BoolP("yes", "y", false, "Pre-approve the deletion of the instance without prompting for confirmation")
